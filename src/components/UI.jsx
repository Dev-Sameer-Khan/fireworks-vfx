...
export const UI = () => {
  ...
  const {addFireworks, fireworks} = useFireworks();
    ...
    <section className="fixed inset-0 z-10 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex gap-4">
          <button onClick={()=>addFireworks({theme : "classic"})} className="bg-white rounded-full px-4 md:px-8 py-2 grayscale hover:filter-none hover:bg-white/20 hover:text-white transition-colors duration-400 cursor-pointer">
            🎆 Classic
          </button>
          <button onClick={()=>addFireworks({theme : "love"})} className="bg-white rounded-full px-4 md:px-8 py-2 grayscale hover:filter-none hover:bg-white/20 hover:text-white transition-colors duration-400 cursor-pointer">
            💖 Love
          </button>
          <button onClick={()=>addFireworks({theme : "sea"})} className="bg-white rounded-full px-4 md:px-8 py-2 grayscale hover:filter-none hover:bg-white/20 hover:text-white transition-colors duration-400 cursor-pointer">
            🌊 Sea
          </button>
        </div>
